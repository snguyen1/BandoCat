                ...
                <div class="card" style="width: 35em;">
                    <div class="card-body">
                        <form name="frm_ticket" id="frm_ticket" method="post">
                            ...
                            <!-- Library Index -->
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="txtSubject0">Library Index 1:</label>
                                <div class="col-sm-9">
                                    <input type = "text" name = "txtSubject" id = "txtSubject0" size="32" class="form-control" required/>
...
<script>
    ...
    function add_fields(length, val) {
        ...
        var html = '<div class="form-group row">' +
            '<label class="col-sm-3 col-form-label" for="txtSubject0">Library Index 1:</label>' +
            '<div class="col-sm-9">\n' +
            '                                    <input type = "text" name = "txtSubject" id = "txtSubject0" size="32" class="form-control" required/></div>' +
            '</div>';
        $('#divSubject').append();
    }
